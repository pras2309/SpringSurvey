...
<head>
    ...
    <%@include file="common/beforeHeader.jsp" %>
</head>
...
<div class="alert alert-block alert-success">
    ...
    <strong class="green">
        W8
        <small>(v1.0)</small>
    </strong>, the lightweight, feature-rich, easy to use and well-documented admin template.
</div>
...
<div class="itemdiv memberdiv">
    <div class="user">
        <img alt="Bob Doe's avatar" src="/assets/themes/images/user.png"/>
    </div>
...
<div class="itemdiv memberdiv">
    <div class="user">
        <img alt="Joe Doe's avatar" src="/assets/themes/images/avatar2.png"/>
    </div>
...
<div class="itemdiv memberdiv">
    <div class="user">
        <img alt="Jim Doe's avatar" src="/assets/themes/images/avatar.png"/>
    </div>
...
<div class="itemdiv memberdiv">
    <div class="user">
        <img alt="Alex Doe's avatar" src="/assets/themes/images/avatar2.png"/>
    </div>
...
<div class="itemdiv memberdiv">
    <div class="user">
        <img alt="Bob Doe's avatar" src="/assets/themes/images/avatar2.png"/>
    </div>
...
<div class="itemdiv memberdiv">
    <div class="user">
        <img alt="Susan's avatar" src="/assets/themes/images/avatar3.png"/>
    </div>
...
<div class="itemdiv memberdiv">
    <div class="user">
        <img alt="Phil Doe's avatar" src="/assets/themes/images/avatar4.png"/>
    </div>
...
<div class="itemdiv memberdiv">
    <div class="user">
        <img alt="Alexa Doe's avatar" src="/assets/themes/images/avatar1.png"/>
    </div>
...
<div id="comment-tab" class="tab-pane">
    <div class="comments">
        <div class="itemdiv commentdiv">
            <div class="user">
                <img alt="Bob Doe's Avatar" src="/assets/themes/images/avatar.png"/>
            </div>
        ...
        <div class="itemdiv commentdiv">
            <div class="user">
                <img alt="Jennifer's Avatar" src="/assets/themes/images/avatar1.png"/>
            </div>
        ...
        <div class="itemdiv commentdiv">
            <div class="user">
                <img alt="Joe's Avatar" src="/assets/themes/images/avatar2.png"/>
            </div>
        ...
        <div class="itemdiv commentdiv">
            <div class="user">
                <img alt="Rita's Avatar" src="/assets/themes/images/avatar3.png"/>
            </div>
            ...
            <div class="widget-main no-padding">
                <div class="dialogs">
                    <div class="itemdiv dialogdiv">
                        <div class="user">
                            <img alt="Alexa's Avatar" src="/assets/themes/images/avatar1.png"/>
                        </div>
                    ...
                    <div class="itemdiv dialogdiv">
                        <div class="user">
                            <img alt="John's Avatar" src="/assets/themes/images/avatar.png"/>
                        </div>
                    ...
                    <div class="itemdiv dialogdiv">
                        <div class="user">
                            <img alt="Bob's Avatar" src="/assets/themes/images/user.png"/>
                        </div>
                    ...
                    <div class="itemdiv dialogdiv">
                        <div class="user">
                            <img alt="Jim's Avatar" src="/assets/themes/images/avatar4.png"/>
                        </div>
...
<%@include file="common/settingsContainer.jsp"%>
</div>
<!--/#main-content-->
</div>
